                        ...
                        <Grid item xs={2} sm={4} md={4} key={index}>
                            <Card variant="outlined" sx={{ maxWidth: 345 }}>
                                ...
                                <CardActions disableSpacing>
                                    <Button sx={{ width: '100px', height: '30px', m: 1, fontSize: '10px' }} variant="contained">Contact</Button>
                                    <Button sx={{ width: '100px', height: '30px', m: 1, fontSize: '10px' }} variant="outlined">Details</Button>
                                </CardActions>
                            </Card>
                        </Grid>
                    )}
